...
def create_soulacais(soulacaisSchema : soulacais_schemas.SoulacaisCreate, db: Session = Depends(get_db)):
...
def update_soulacais(soulacaisSchema: soulacais_schemas.SoulacaisUpdate, db: Session = Depends(get_db)):
